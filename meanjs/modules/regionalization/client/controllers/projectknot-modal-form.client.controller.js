(function () {
  ...
  ProjectKnotModalFormController.$inject = ['$scope', '$log', '$window', '$uibModalInstance', 'projectData', 'method', 'ProgressService', 'Notification', 'Upload', 'localStorageService'];
  function ProjectKnotModalFormController($scope, $log, $window, $uibModalInstance, projectData, method, ProgressService, Notification, Upload, localStorageService) {
    var vm = this;
    ...
    if (method === '结项') {
      vm.projectData.knotstate = knots[0].knotname;
