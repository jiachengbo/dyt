(function () {
  ...
  angular
    ...
    .controller('PartyBuildInstructorTableCURDTableController', PartyBuildInstructorTableCURDTableController);

  PartyBuildInstructorTableCURDTableController.$inject = ['$scope', 'Notification', '$log', '$window', 'PartyBuildInstructorTableService',
    '$uibModal', 'Authentication', 'CommunityService', 'localStorageService'];
  function PartyBuildInstructorTableCURDTableController($scope, Notification, $log, $window, PartyBuildInstructorTableService, $uibModal, Authentication, CommunityService, localStorageService) {
    var vm = this;
    vm.userCommId = '';
    //表数据
    vm.tableData = [];
    ...
    vm._openModal = function (resarg) {
      return $uibModal.open({
        templateUrl: '/modules/baseinfomanage/client/views/partybuildinstructortable-modal-form.client.view.html',
        controller: 'PartyBuildInstructorTableModalFormController',
        controllerAs: 'vm',
        backdrop: 'static',
        size: 'lg',
    ...
    vm.gridOptions = {
      ...
      columnDefs: [
        ...
        {field: 'type_style', displayName: '类别'},
        {field: 'member_number', displayName: '职工人数'},
        {field: 'mass_organization', displayName: '群团组织'},
        {field: 'business_contact', displayName: '企业联系人'},
        {field: 'party', displayName: '党建类型'},
        {field: 'CommunityVillageConstant.name', displayName: '所属社区'},
        {field: 'contact_number', displayName: '企业联系人联系电话'},
        {field: 'address', displayName: '地址'},
        {field: 'build_instructor', displayName: '党建指导员'},
        {field: 'instructor_number', displayName: '党建指导员联系电话'}
      ],
//-------------分页1.页面操作参数---------------
