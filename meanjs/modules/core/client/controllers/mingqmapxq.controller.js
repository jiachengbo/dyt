(function () {
  ...
  angular
    .module('core')
    .controller('mingqMapxqController', mingqMapxqController);
  mingqMapxqController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'GetStreetMemberService', 'GetCommMemberService', 'GetPartyBuildService'];
  function mingqMapxqController($scope, $rootScope, $state, $stateParams, GetStreetMemberService, GetCommMemberService, GetPartyBuildService) {
    var vm = this;
    ...
    //   vm.type = '社区信息';
    // }
    var units = angular.element(document.querySelectorAll('#mingqingmap>.col-md-12>div'));
