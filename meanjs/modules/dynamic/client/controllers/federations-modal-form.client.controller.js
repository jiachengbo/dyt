(function () {
  ...
  FederationsinfovmdalFormController.$inject = ['$scope', '$log', '$uibModalInstance', 'FederationsData', 'method', 'localStorageService', 'userCommId'];
  function FederationsinfovmdalFormController($scope, $log, $uibModalInstance, FederationsData, method, localStorageService, userCommId) {
    var vm = this;
