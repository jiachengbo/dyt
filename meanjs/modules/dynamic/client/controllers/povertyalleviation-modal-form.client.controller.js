(function () {
  ...
  PovertyAlleviationinfoModalFormController.$inject = ['$scope', '$uibModalInstance', 'PovertyAlleviationData', 'method', 'localStorageService', 'userCommId', '$window'];
  function PovertyAlleviationinfoModalFormController($scope, $uibModalInstance, PovertyAlleviationData, method, localStorageService, userCommId, $window) {
    var vm = this;
